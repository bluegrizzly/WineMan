                ...
                jQuery("#jQGridDemo").jqGrid({
                    ...
                    colModel: [
                                { name: 'id', index: 'id', width: 30, stype: 'text' },
   		                        { name: 'client_id', index: 'client_id', width: 40, stype: 'text', sortable: true, editable: true},
   		                        ...
   		                        { name: 'date_creation', index: 'date_creation', width: 150, sortable: true, editable: true },
                                { name: 'date_bottling', index: 'date_bottling', width: 150, sortable: true, editable: true },
